...
public class Item {
	...
	private int itemQuantityToPurchase;
...
*/
	...
	public int getItemQuantityToPurchase() {
		return itemQuantityToPurchase;
	}

	public void setItemQuantityToPurchase(int itemQuantityToPurchase) {
		this.itemQuantityToPurchase = itemQuantityToPurchase;
	}
