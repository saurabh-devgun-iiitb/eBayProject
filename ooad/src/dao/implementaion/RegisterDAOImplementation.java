...
public class RegisterDAOImplementation implements RegisterDAO {
	...
	public boolean registerUser(User user) {
		...
		try {
			...
			PreparedStatement ps = cs.connect().prepareStatement("INSERT INTO users(user_id, user_name,user_email,user_password,user_type) VALUES (?, ?, ?, ?, ?)");
			...
			String message = "User with email : " + user.getUserEmail() + " is registered";
