...
<%
	...
	try {
		...
		ps = dbConnection.connect().prepareStatement("SELECT user_name FROM users where user_email='admin'");
		rs = ps.executeQuery();
		if(rs.next())
			advcost = rs.getString(1);
	}
	catch(Exception e) {
...
%>
		...
		<input type="hidden" id="advCost" value="<%=advcost %>">
					  	...
					  	<div id="advt-detail" class="hidden">
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-sm-8">
							    	...
							    	<input type="text" id="itemAdvtCost2" class="form-control" disabled="disabled"  name="item.itemAdvtCost" />
							    </div>
						  	</div>
						</div> 
						<hr>
  ...
  <div class="modal fade" id="myModal" role="dialog">
	...
	<script src="js/bootstrap.min.js"></script>
		...
		function setAdvtCost() {
			//console.log($('#advCost').val());
			var val = $('#itemPrice').val() * parseFloat($('#advCost').val()) * days;
			$('#itemAdvtCost1').val(val.toFixed(2));
			$('#itemAdvtCost2').val(val.toFixed(2));
