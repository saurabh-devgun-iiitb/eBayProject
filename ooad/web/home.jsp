...
<body>
	...
	<!-- // Modal to show after delete account -->
...
<%
	if(login != null && login.equals("deleted")) {	System.out.println("hi");
	session.invalidate();
%>
...
<%
	if(login != null && login.equals("deleted")) {	
%>
					$("#success").modal('show');
<%
	} else {
	...
	<nav class="nav navbar-default" style="border-bottom: 1px solid #CBCCCA;">
		<div class="container header">
			<ul class="navbar-left header-nav" style="margin-bottom: 5px;">
				<li><a href="signIn.jsp?success=none">Sign in</a></li>
				<li><a href="registerPage2">Register</a></li>
				
				<%-- <li><span class="dealreference">
				<a href=dealPageDisplay.jsp >Deals </a>
				<span class="dealreferencehover row">
				<span class="col-sm-2">				
				</br>				
					<a href="getBuyTwoGetOneItems">			
					  Buy 2 Get 1
					</a>
					</span>
					<span class="col-sm-10">
					<img src="images/cooldeals.jpg" style="width: 100%; float:right;padding:2px;" />
					</span>
				</span>				
				</span>				
				</li> --%>
		...
		<%	        
	     ...
	     <%   		}
	      ...
	      %>
						...
						<li><a href="registerSeller.jsp">Sell</a></li>
	      <%      
	        }
    %>			<!-- <li><a href="#">Sell </a></li> -->
				<li><a href="signIn.jsp?success=none&to=true">Track My Order</a></li>
			</ul>
