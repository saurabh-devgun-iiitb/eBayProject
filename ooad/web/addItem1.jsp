				...
				<s:form name="itemForm" action="addItem" method="post" namespace="/" enctype="multipart/form-data" class="form-horizontal">
  					<div class="panel-body">
						...
						<div class="form-group">
					    	...
					    	<div class="col-sm-8">
					<%
							if(result.equals("updateItem")) {
					%>    	
								<input type="text" class="form-control" disabled="disabled" value='<s:property value="itemDetails.category.categoryName"/>'>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
								<input type="text" class="form-control" disabled="disabled" value='<s:property value="itemDetails.subCategory.subCategoryName"/>'>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
								<input type="text" class="form-control" disabled="disabled" value='<s:property value="itemDetails.item.itemId"/>'>
					<%		} else {
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
								<input type="text" class="form-control" value='<s:property value="itemDetails.item.itemName"/>'>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
								  <textarea rows="2" class="form-control"><s:property value="itemDetails.item.itemDescription"/></textarea>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
								<input type="text" class="form-control" value='<s:property value="itemDetails.item.itemPictureString"/>'>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
								<input type="text" class="form-control" value='<s:property value="itemDetails.item.itemPrice"/>'>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
								<input type="text" class="form-control" value='<s:property value="itemDetails.item.itemDiscount"/>'>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
								<input type="text" class="form-control" value='<s:property value="itemDetails.item.itemQuantityAvailable"/>'>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
									<input type="text" class="form-control" value='<s:property value="itemDetails.item.itemWarrantyPeriod"/>'>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
									<input type="text" class="form-control" value='<s:property value="itemDetails.item.itemAdvertisement"/>'>
					<%		} else {
					%>
						    	<div class="radio">
						  		 	<label>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
									<input type="text" class="form-control" value='<s:property value="itemDetails.item.itemAdvFrom"/>'>
					<%		} else {
					%>
					...
					<%
							if(result.equals("updateItem")) {
					%>    	
									<input type="text" class="form-control" value='<s:property value="itemDetails.item.itemAdvTo"/>'>
					<%		} else {
					%>
