		...
		<div class="row">
			...
			%>
					<div class="thumbnail" style="padding: 20px 20px;">
						...
						<div class="col-md-10 text-right" style="padding-right: 20px;">
			...
			%>					<a href="rateSeller.jsp?r=<%=i %>&sId=<%=buyer.getBuyerSellerSurrogateId() %>"><i class="fa fa-star"></i></a>
			<%			}
						else {
			%>
								<a href="rateSeller.jsp?r=<%=i %>&sId=<%=buyer.getBuyerSellerSurrogateId() %>"><i class="fa fa-star-o"></i></a>
			<%			}
					}
			%>				</div>
						</div>
