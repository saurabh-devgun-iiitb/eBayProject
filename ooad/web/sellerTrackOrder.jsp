...
<body>
	...
	<%
			...
			ArrayList<Buyer> buyers = new ItemDAOImplementation().getSellHistory(userid);
			
			System.out.println("SellerTrackOrder.jsp , UserId=" + userid);
			int sellersid = new PaymentDAOImplementation().getSeller(userid);
			
			System.out.println("SellerTrackOrder.jsp , sellersid=" + sellersid);
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-10" style="padding-left: 40px;">
				<p style="font-size: 18px; color: #CE1F24; border-bottom: 2px solid #D0D0D0;"><strong>MY SELLS</strong></p>
			<%
				for(Buyer buyer : buyers) {
					System.out.println(buyer.getBuyerSellerSurrogateId() + " == " + sellersid);
					if(buyer.getBuyerSellerSurrogateId() == sellersid) {
			%>
					<div class="thumbnail" style="padding: 20px 20px;">
						<div class="col-md-4">
							<h6>Order ID : <%=buyer.getBuyerSurrogateId() %>&nbsp;(1 items)</h6>
			...
			%>			<a href="itemDispatched.jsp?bId=<%=buyer.getBuyerSurrogateId() %>" type="button" class="btn btn-primary">Dispatch</a>
			<%		}
			%>			</div>
