...
<div class="container-fluid" style="margin-top:10px">
	<s:iterator value="dealsItemList"> 
	<s:if test='item_three.item_quantity_available == 0' >
	</s:if>
	<s:elseif test='item_two.item_quantity_available == 0'></s:elseif>
	<s:elseif test='item_one.item_quantity_available == 0'></s:elseif>
	<s:else>
	</br>     <!--iterate over the array list-->
	    <s:iterator >     
	    <form action="addDealDirectly">
	    <div class="row" style="margin:5px;border:2px solid gray">
	    	<div class="col-sm-3" style="padding:20px; margin:10px;">
				<div class="item_container">
	      		...
	      		<s:property value="item_one.item_id"/> </br>
	      			        	...
	      			        	<input type = "hidden" name = "item_one.item_id" value = '<s:property value="item_one.item_id"/>'/>
	        	...
	        	<s:property value="item_one.item_price"/></br>
	        		        	<label style="width:100px;">Item Discount</label>
	        	<s:property value="item_one.item_discount"/> %</br>
	        	<label style="width:100px;">Item Quantity</label>
	        	<s:property value="item_one.item_quantity_available"/></br>
	        	</div>
	        	...
	        	<img src="showPicture.jsp?image=<s:property value="item_two.item_picture"/>" style="width:100%;height:100%;margin-top:0px"/></br>
	           	...
	           	<input type = "hidden" name = "item_two.item_id" value = '<s:property value="item_two.item_id"/>'/>
	        		        	<label style="width:100px;">Item Name</label>
	        	...
	        	<s:property value="item_two.item_price"/></br>
	        		        	<label style="width:100px;">Item Discount</label>
	        	<s:property value="item_two.item_discount"/> %</br>
	        	<label style="width:100px;">Item Quantity</label>
	        	<s:property value="item_two.item_quantity_available"/></br>
	        	</div>
	        ...
	        `	
	        	...
	        	<img src="showPicture.jsp?image=<s:property value="item_three.item_picture"/>" style="width:100%;height:100%;margin-top:0px;"><img src="images/FreeBadge.png" id="ins"/></img></br>
	        		        	...
	        		        	<label style="width:100px;">Item id</label>
	        		        	<input type = "hidden" name = "item_three.item_id" value = '<s:property value="item_three.item_id"/>'/>
	        	...
	        	<s:property value="item_three.item_price"/></br>
	        		        	<label style="width:100px;">Item Discount</label>
	        	<s:property value="item_three.item_discount"/> %</br>
	        	<label style="width:100px;">Item Quantity</label>
	        	<s:property value="item_three.item_quantity_available"/></br>
