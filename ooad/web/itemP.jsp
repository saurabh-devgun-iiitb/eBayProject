	...
	<div class="row" style="padding-left: 30px; padding-right: 10px;">	
		...
		<div class="col-md-8" style="padding-left: 20px;">
		  <form action="CartAction">
			<input id="itemId" name="itemId" value="<%=item.getItemId() %>">
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
						<div class="buy-option">
							...
							<strong class="col-md-3">Rs <%=item.getItemPrice() %></strong>
							<div class="col-md-6">
...
// 		function addToCart() {
// 			window.location.href = "Cart.jsp?id=" + $('#itemId').val() + "&qty=" + $('#quantity').val();
// 		}
	</script>
</body>
</html>
